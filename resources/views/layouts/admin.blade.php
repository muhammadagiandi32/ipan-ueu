							...
							<div class="d-flex align-items-stretch flex-shrink-0">
												...
												<div data-kt-search-element="results" class="d-none">
													...
													<div class="scroll-y mh-200px mh-lg-350px">
														...
														<a href="#"
															...
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="{{ asset('assets/dist/assets/media/avatars/300-2.jpg')}}"
																	alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#"
															...
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="{{ asset('assets/dist/assets/media/avatars/300-9.jpg')}}"
																	alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#"
															...
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="{{ asset('assets/dist/assets/media/avatars/300-14.jpg')}}"
																	alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
								...
								<div class="d-flex align-items-center ms-1 ms-lg-3">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-primary fw-bold py-4 fs-6 w-200px"
										...
										<!--begin::Menu item-->
										<div class="menu-item px-3 my-1">
											<a href="/metronic8/demo1/../demo1/dark/account/security.html"
					...
					<div class="toolbar" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
							...
							<div class="d-flex align-items-center gap-2 gap-lg-3">
								{{-- <a href="/metronic8/demo1/../demo1/.html" class="btn btn-sm btn-primary"
							...
							<div class="timeline-content mb-10 mt-n1">
								...
								<div class="overflow-auto pb-5">
									...
									<div
										...
										<!--begin::Title-->
										<a href="/metronic8/demo1/../demo1/apps/projects/project.html"
							...
							<div class="row g-5">
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="/metronic8/demo1/assets/media/demos/demo24.png" alt="demo"
												class="w-100 opacity-25" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon
				...
				<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true"
					...
					<div class="d-flex align-items-center mb-7">
						...
						<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
							...
							<div class="d-flex flex-column me-2 me-lg-5">
								<!--begin::Title-->
								<a href="/metronic8/demo1/../demo1/documentation/base/utilities.html"
						...
						<div class="flex-row-fluid py-lg-5 px-lg-15">
							...
							<form class="form" id="form_myclass" action="{{ url('/myclass/insert') }}" method="POST">
									...
									<div class="w-100">
										...
										<div class="fv-row mb-10">
											...
											<input type="text" class="form-control form-control-lg form-control-solid"
												name="class_name" placeholder="" value="" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
										<!--begin::Input group-->
								...
								<div class="d-flex flex-stack pt-10">
									...
									<!--begin::Wrapper-->
									<div>
										<button type="submit" id="submit_form" class="btn btn-lg btn-primary"
						...
						<form class="mx-auto mw-500px w-100 pt-15 pb-10" novalidate="novalidate"
							...
							<div data-kt-stepper-element="content">
								...
								<div class="w-100">
									...
									<!--begin::Illustration-->
									<div class="text-center px-4">
										<img src="/metronic8/demo1/assets/media/illustrations/sketchy-1/20.png" alt=""
						...
						<div class="mh-300px scroll-y me-n7 pe-7">
							...
							<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic"
											src="{{ asset('assets/dist/assets/media/avatars/300-21.jpg')}}" />
									</div>
									<!--end::Avatar-->
									<!--begin::Details-->
									<div class="ms-5">
